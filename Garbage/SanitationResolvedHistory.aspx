<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SanitationResolvedHistory.aspx.cs" Inherits="SanitationResolvedHistory" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Resolved History | Sanitation Dept</title>
            ...
            <aside class="hidden md:flex w-72 flex-col bg-white border-r border-slate-200 z-20">
                ...
                <nav class="flex-1 py-6 px-4 space-y-1.5 overflow-y-auto no-scrollbar">
                   ...
                   <%-- <a href="CollectionRoutes.aspx" class="nav-link flex items-center px-4 py-3 text-sm">
                    ...
                    <a href="SanitationResolvedHistory.aspx" class="nav-link active flex items-center px-4 py-3 text-sm">
                ...
                <main class="flex-1 overflow-y-auto p-4 md:p-8">
                    ...
                    <div class="content-card overflow-hidden">
                        <div class="px-4 md:px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-white">
                            <h3 class="font-bold text-slate-800 uppercase text-sm tracking-wide">Cleaning Logs</h3>
                        </div>
                                        ...
                                        <ItemTemplate>
                                            <tr class="hover:bg-green-50/30 transition duration-150">
                                                ...
                                                <td class="p-4 min-w-[200px]">
                                                    <div class="font-mono text-xs text-green-600 font-bold mb-0.5">#SNT-<%# Eval("ComplaintID") %></div>
                                                ...
                                                <td class="p-4 font-semibold text-blue-700 whitespace-nowrap">
                                                    <%# string.IsNullOrEmpty(Eval("StaffName").ToString()) ? "Sanitation Staff" : Eval("StaffName") %>
                                                </td>
