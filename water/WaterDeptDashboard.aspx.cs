...
public partial class WaterDeptDashboard : System.Web.UI.Page
{
        ...
        try
        {
            using (SqlConnection con = new SqlConnection(connString))
            {
                string query = "SELECT " +
                               ...
                               "WHERE c.AssignedDepartment = 'Water' AND c.Status != 'Rejected' AND c.Status != 'Resolved' " +
        ...
        try
        {
            using (SqlConnection con = new SqlConnection(connString))
            {
                string query = "SELECT " +
                               ...
                               "FROM tbl_Complaints WHERE AssignedDepartment = 'Water' AND Status != 'Rejected'";
        ...
        try
        {
            using (SqlConnection con = new SqlConnection(connString))
            {
                string query = "SELECT s.StaffID, s.FullName, " +
                               ...
                               "FROM tbl_staff s WHERE s.Department = 'Water' AND s.IsActive = 1";
            ...
            using (SqlConnection con = new SqlConnection(connString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    if (cmd.ExecuteNonQuery() > 0)
                    {
                        ...
                        // 🔥 Fire Dual Email Notifications (To Citizen AND to Staff)
            ...
            using (SqlConnection con = new SqlConnection(connString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, con))
                {
                    ...
                    if (cmd.ExecuteNonQuery() > 0)
                    {
                        ...
                        // 🔥 Send Resolved Notification to Citizen
    ...
    private void SendEmailNotification(int complaintId, string actionType, string staffName, string remarks)
    {
        try
        {
            ...
            string fullCompId = "WTR-" + complaintId;
            ...
            if (!string.IsNullOrEmpty(citizenEmail))
            {
                ...
                citMail.From = new MailAddress(senderEmail, "CiviCare Water Dept");
                ...
                if (actionType == "Assigned")
                {
                    ...
                    citMail.Body = "<html><body style='font-family:Arial,sans-serif; background-color:#f8fafc; margin:0; padding:20px;'>" +
                                   ...
                                   "<div style='background-color:#3b82f6; color:#ffffff; padding:20px; text-align:center;'><h2 style='margin:0; font-size:24px;'>Team Assigned</h2></div>" +
                                   "<div style='padding:30px; color:#333333;'><h3 style='margin-top:0;'>Hello " + citizenName + ",</h3>" +
                                   "<p>A field team has been dispatched to resolve your Water Department complaint.</p>" +
                                   ...
                                   "</div><p>Our team is on the way. Track live updates on your dashboard.</p><br/><p>Regards,<br/><strong>Water Department, CiviCare</strong></p>" +
                                   "</div></div></body></html>";
                }
                else if (actionType == "Resolved")
                {
                    ...
                    citMail.Body = "<html><body style='font-family:Arial,sans-serif; background-color:#f8fafc; margin:0; padding:20px;'>" +
                                   ...
                                   "<div style='padding:30px; color:#333333;'><h3 style='margin-top:0;'>Hello " + citizenName + ",</h3>" +
                                   "<p>Your Water Department complaint has been successfully resolved.</p>" +
                                   "<div style='background-color:#f0fdf4; border-left:4px solid #22c55e; padding:15px; margin:20px 0;'>" +
                                   "<p style='margin:0 0 10px 0;'><strong>Complaint ID:</strong> " + fullCompId + "</p>" +
                                   "<p style='margin:0 0 10px 0;'><strong>Location:</strong> " + locationName + "</p>" +
                                   "<p style='margin:0;'><strong>Action Taken:</strong> " + remarks + "</p>" +
                                   "</div><p>Thank you for helping us keep the city clean!</p><br/><p>Regards,<br/><strong>Water Department, CiviCare</strong></p>" +
                                   "</div></div></body></html>";
                }
                smtp.Send(citMail);
            }
            ...
            if (actionType == "Assigned" && !string.IsNullOrEmpty(staffEmail))
            {
                ...
                string staffBody = "<html><body style='font-family:Arial,sans-serif; background-color:#f8fafc; margin:0; padding:20px;'>" +
                                   ...
                                   "<p>You have been assigned a new field task by the Water Department.</p>" +
                                   ...
                                   "</div><p>Please resolve this issue at the earliest.</p><br/><p>Regards,<br/><strong>Water Department Operations</strong></p>" +
                                   "</div></div></body></html>";
