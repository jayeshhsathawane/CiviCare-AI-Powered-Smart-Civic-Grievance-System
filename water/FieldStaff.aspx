<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FieldStaff.aspx.cs" Inherits="FieldStaff" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Manage Field Staff | Water Dept</title>
        ...
        <div class="flex h-screen overflow-hidden">
            ...
            <aside class="hidden md:flex w-72 flex-col bg-white border-r border-slate-200 z-20">
                ...
                <nav class="flex-1 py-6 px-4 space-y-1.5 overflow-y-auto no-scrollbar">
                    ...
                    <a href="FieldStaff.aspx" class="nav-link active flex items-center px-4 py-3 text-sm">
                ...
                <header class="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-4 md:px-8 shadow-sm z-10">
                    ...
                    <div class="flex items-center gap-6">
                        <div class="flex items-center gap-3 pl-6 border-l border-slate-200">
                            ...
                            <div class="w-10 h-10 rounded-full bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 font-bold shadow-sm">
                    ...
                    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                        <ContentTemplate>
                            ...
                            <div class="content-card mb-8 overflow-hidden bg-white">
                                <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-5 flex items-center gap-4 border-b border-blue-700">
                                    ...
                                    <div>
                                        <h3 class="font-bold text-white text-lg">Add New Plumber / Worker</h3>
                                        <p class="text-xs text-blue-100 mt-0.5">Register new staff to assign them pipeline and leak repairs.</p>
                                    </div>
                                </div>
                                ...
                                <div class="p-6 md:p-8">
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <asp:TextBox ID="txtName" runat="server" CssClass="form-input" placeholder="e.g. Amit Patil"></asp:TextBox>
                                            </div>
                                            <asp:RequiredFieldValidator ID="rfvName" runat="server" ControlToValidate="txtName" ErrorMessage="Full Name is required" ValidationGroup="AddStaff" CssClass="val-error" Display="Dynamic" />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvMobile" runat="server" ControlToValidate="txtMobile" ErrorMessage="Mobile No. is required" ValidationGroup="AddStaff" CssClass="val-error" Display="Dynamic" />
                                            <asp:RegularExpressionValidator ID="revMobile" runat="server" ControlToValidate="txtMobile" ValidationExpression="^\d{10}$" ErrorMessage="Enter a valid 10-digit number" ValidationGroup="AddStaff" CssClass="val-error" Display="Dynamic" />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="txtEmail" ErrorMessage="Email is required" ValidationGroup="AddStaff" CssClass="val-error" Display="Dynamic" />
                                            <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="txtEmail" ValidationExpression="^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$" ErrorMessage="Enter a valid Email ID" ValidationGroup="AddStaff" CssClass="val-error" Display="Dynamic" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-8 pt-6 border-t border-slate-100 flex justify-end gap-3">
                                        ...
                                        <asp:Button ID="btnAddStaff" runat="server" Text="Register Staff" OnClick="btnAddStaff_Click" ValidationGroup="AddStaff" CssClass="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg shadow-md transition cursor-pointer text-sm" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="content-card overflow-hidden">
                                <div class="px-6 py-5 border-b border-slate-100 bg-white flex justify-between items-center">
                                    <h3 class="font-bold text-slate-800 text-lg flex items-center gap-2">
                                        <i class="fa-solid fa-users-gear text-blue-500"></i> Water Dept Staff Directory
                                    </h3>
                                </div>
                                            ...
                                            <asp:Repeater ID="rptStaff" runat="server" OnItemCommand="rptStaff_ItemCommand">
                                                <ItemTemplate>
                                                    <tr class="hover:bg-blue-50/30 transition duration-150">
                                                        <td class="p-4 pl-6">
                                                            <div class="flex items-center gap-3">
                                                                <div class="w-10 h-10 rounded-full flex items-center justify-center text-xs font-bold bg-blue-100 text-blue-600 border border-blue-200 shadow-sm">
                                                        ...
                                                        <td class="p-4 text-center pr-6">
                                                            <div class="flex justify-center items-center gap-3">
                                                                <asp:LinkButton ID="btnToggle" runat="server" CommandName="ToggleStatus" CommandArgument='<%# Eval("StaffID") + "|" + Eval("IsActive") + "|" + Eval("FullName") %>' 
                                                                    ...
                                                                    CssClass='<%# Convert.ToBoolean(Eval("IsActive")) ? "text-blue-500 hover:text-blue-700 transition text-lg bg-blue-50 w-8 h-8 rounded flex items-center justify-center border border-blue-100" : "text-green-600 hover:text-green-800 transition text-lg bg-green-50 w-8 h-8 rounded flex items-center justify-center border border-green-100" %>'>
