<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricResolvedHistory.aspx.cs" Inherits="ElectricResolvedHistory" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Resolved History | Electric Dept</title>
        ...
        <div class="flex h-screen overflow-hidden">
            ...
            <aside class="hidden md:flex w-72 flex-col bg-white border-r border-slate-200 z-20">
                ...
                <nav class="flex-1 py-6 px-4 space-y-1.5 overflow-y-auto no-scrollbar">
                    ...
                    <a href="ElectricResolvedHistory.aspx" class="nav-link active flex items-center px-4 py-3 text-sm">
            ...
            <div class="flex-1 flex flex-col overflow-hidden bg-slate-50">
                ...
                <header class="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-4 md:px-8 shadow-sm z-10">
                    <div class="flex items-center gap-4">
                        ...
                        <h2 class="text-lg md:text-xl font-bold text-slate-800">Resolved Complaints Logs</h2>
                    </div>
                ...
                <main class="flex-1 overflow-y-auto p-4 md:p-8">
                    ...
                    <div class="content-card overflow-hidden">
                        <div class="px-4 md:px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-white">
                            <h3 class="font-bold text-slate-800 uppercase text-sm tracking-wide">Repair Logs</h3>
                        </div>
                                        ...
                                        <ItemTemplate>
                                            <tr class="hover:bg-orange-50/30 transition duration-150">
                                                ...
                                                <td class="p-4 min-w-[200px]">
                                                    <div class="font-mono text-xs text-orange-600 font-bold mb-0.5">#ELEC-<%# Eval("ComplaintID") %></div>
                                                ...
                                                <td class="p-4 font-semibold text-blue-700 whitespace-nowrap">
                                                    <%# string.IsNullOrEmpty(Eval("StaffName").ToString()) ? "Grid Staff" : Eval("StaffName") %>
                                                </td>
