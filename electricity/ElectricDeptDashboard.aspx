<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricDeptDashboard.aspx.cs" Inherits="ElectricDeptDashboard" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Electricity Dept | Dashboard</title>
    ...
    <style>
        ...
        .task-card:hover { box-shadow: 0 10px 15px -3px rgba(0,0,0,0.05); border-color: #fed7aa; }
        ...
        <div class="flex h-screen overflow-hidden">
            ...
            <aside class="hidden md:flex w-72 flex-col bg-white border-r border-slate-200 z-20">
                ...
                <nav class="flex-1 py-6 px-4 space-y-1.5 overflow-y-auto no-scrollbar">
                    ...
                    <a href="ElectricDeptDashboard.aspx" class="nav-link active flex items-center px-4 py-3 text-sm">
            ...
            <div class="flex-1 flex flex-col overflow-hidden bg-slate-50">
                ...
                <header class="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-4 md:px-8 shadow-sm z-10">
                    <div class="flex items-center gap-4">
                        ...
                        <h2 class="text-xl font-bold text-slate-800 hidden md:block">Electricity Operations Dashboard</h2>
                    </div>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="space-y-3">
                                    ...
                                    <ItemTemplate>
                                        <div class="task-card">
                                            ...
                                            <div class='<%# GetPriorityHeaderCss(Eval("PriorityLevel").ToString()) %> px-5 py-2.5 border-b flex justify-between items-center'>
                                                ...
                                                <span class="text-xs font-mono font-bold opacity-80">ID: #ELEC-<%# Eval("ComplaintID") %></span>
                                            </div>
                                ...
                                <div id="noDataPanel" runat="server" visible="false" class="text-center py-16 bg-white border border-slate-200 rounded-xl shadow-sm">
                                    ...
                                    <p class="text-slate-500 text-sm mt-1">There are no active electricity complaints pending.</p>
                                </div>
                            </div>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <asp:TextBox ID="txtAdminComment" runat="server" TextMode="MultiLine" Rows="3" CssClass="w-full p-2.5 border border-slate-300 rounded-lg outline-none focus:border-blue-500 text-sm" placeholder="E.g., Take safety gear..."></asp:TextBox>
                            </div>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <asp:TextBox ID="txtResolveRemark" runat="server" TextMode="MultiLine" Rows="3" CssClass="w-full p-2.5 border border-slate-300 rounded-lg outline-none focus:border-green-500 text-sm" placeholder="E.g., Pole repaired and wire insulated."></asp:TextBox>
                            </div>
